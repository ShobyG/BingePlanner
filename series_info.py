...
class SeriesInfo:
    def __init__(self, imdb_id):
        ...
        self.series_type = self.series_info['type']
        ...
        if self.series_type == 'TVSeries':
            ...
            self.series_runtime_data = ['0'] * (1)
            self.series_runtime_totals = ['0'] * (1)
        self.__set_series_data()

    def __set_series_data(self):
        self.series_dict = {}
        self.episode_dict = {}
        if self.series_type == 'Movie':
            self.series_runtime_data[0] = self.series_info['runtimeMins']
            self.series_runtime_totals[0] = self.series_runtime_data[0]
        else:
        ...
        if self.series_type == 'Movie':
            self.seasons_tot = None
            self.season_tot_episodes = None
            self.season_episodes = None
